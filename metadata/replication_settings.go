...
var CLogQueueCapacityConfig = &SettingsConfig{base.DefaultCLogQueueCapacity, &Range{1, 60000}}                                            // conflict logging queue capacity accross nozzles for a pipeline
...
func (s *ReplicationSettings) GetComponentEventsChanLength() int {
	val, _ := s.GetSettingValueOrDefaultValue(ComponentEventsChanLengthKey)
	return val.(int)
}
