...
func (rm *replicationManager) init(
	...
	fac := factory.NewXDCRFactory(repl_spec_svc, remote_cluster_svc, cluster_info_svc,
		...
		rm, rm.utils, collectionsManifestSvc, rm.getBackfillMgr)
	...
	rm.backfillMgr = backfill_manager.NewBackfillManager(collectionsManifestSvc, repl_spec_svc, backfillReplSvc, pipelineMgrObj, cluster_info_svc, xdcr_topology_svc)
