...
func InitConstants(xdcr_topology_svc service_def.XDCRCompTopologySvc, internal_settings_svc service_def.InternalSettingsSvc) {
	...
	base.InitConstants(time.Duration(internal_settings.Values[metadata.TopologyChangeCheckIntervalKey].(int))*time.Second,
		...
		time.Duration(internal_settings.Values[metadata.CollectionsWatcherWaitTimeKey].(int))*time.Second,
		internal_settings.Values[metadata.CollectionsWatcherBackoffFactorKey].(int),
		time.Duration(internal_settings.Values[metadata.CollectionsWatcherMaxWaitTimeKey].(int))*time.Second,
		internal_settings.Values[metadata.MaxAllowedRCDegradedCyclesForCngKey].(int),
