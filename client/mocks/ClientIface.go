...
// CreateRandomScan provides a mock function with given fields: vb, collId, sampleSize, context
func (_m *ClientIface) CreateRandomScan(vb uint16, collId uint32, sampleSize int, context ...*memcached.ClientContext) (*gomemcached.MCResponse, error) {
	_va := make([]interface{}, len(context))
	for _i := range context {
		_va[_i] = context[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, vb, collId, sampleSize)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *gomemcached.MCResponse
	if rf, ok := ret.Get(0).(func(uint16, uint32, int, ...*memcached.ClientContext) *gomemcached.MCResponse); ok {
		r0 = rf(vb, collId, sampleSize, context...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gomemcached.MCResponse)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(uint16, uint32, int, ...*memcached.ClientContext) error); ok {
		r1 = rf(vb, collId, sampleSize, context...)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateRangeScan provides a mock function with given fields: vb, collId, start, excludeStart, end, excludeEnd, context
func (_m *ClientIface) CreateRangeScan(vb uint16, collId uint32, start []byte, excludeStart bool, end []byte, excludeEnd bool, context ...*memcached.ClientContext) (*gomemcached.MCResponse, error) {
	_va := make([]interface{}, len(context))
	for _i := range context {
		_va[_i] = context[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, vb, collId, start, excludeStart, end, excludeEnd)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *gomemcached.MCResponse
	if rf, ok := ret.Get(0).(func(uint16, uint32, []byte, bool, []byte, bool, ...*memcached.ClientContext) *gomemcached.MCResponse); ok {
		r0 = rf(vb, collId, start, excludeStart, end, excludeEnd, context...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gomemcached.MCResponse)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(uint16, uint32, []byte, bool, []byte, bool, ...*memcached.ClientContext) error); ok {
		r1 = rf(vb, collId, start, excludeStart, end, excludeEnd, context...)
	} else {
		r1 = ret.Error(1)
	}
