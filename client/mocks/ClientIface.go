...
// AuthAdvanced provides a mock function with given fields: user, pass
func (_m *ClientIface) AuthAdvanced(user string, pass string) (*gomemcached.MCResponse, error) {
	ret := _m.Called(user, pass)
...
// AuthSHA provides a mock function with given fields: user, pass, mech, hashFunc, hashSize
func (_m *ClientIface) AuthSHA(user string, pass string, mech string, hashFunc func() hash.Hash, hashSize int) (*gomemcached.MCResponse, error) {
	ret := _m.Called(user, pass, mech, hashFunc, hashSize)

	var r0 *gomemcached.MCResponse
	if rf, ok := ret.Get(0).(func(string, string, string, func() hash.Hash, int) *gomemcached.MCResponse); ok {
		r0 = rf(user, pass, mech, hashFunc, hashSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gomemcached.MCResponse)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, string, func() hash.Hash, int) error); ok {
		r1 = rf(user, pass, mech, hashFunc, hashSize)
	} else {
		r1 = ret.Error(1)
	}
...
// AuthSHA1 provides a mock function with given fields: user, pass
func (_m *ClientIface) AuthSHA1(user string, pass string) (*gomemcached.MCResponse, error) {
	ret := _m.Called(user, pass)
...
// AuthSHA256 provides a mock function with given fields: user, pass
func (_m *ClientIface) AuthSHA256(user string, pass string) (*gomemcached.MCResponse, error) {
	ret := _m.Called(user, pass)
...
// AuthSHA512 provides a mock function with given fields: user, pass
func (_m *ClientIface) AuthSHA512(user string, pass string) (*gomemcached.MCResponse, error) {
	ret := _m.Called(user, pass)
...
// GetBulk provides a mock function with given fields: vb, keys, rv
func (_m *ClientIface) GetBulk(vb uint16, keys []string, rv map[string]*gomemcached.MCResponse) error {
	ret := _m.Called(vb, keys, rv)

	var r0 error
	if rf, ok := ret.Get(0).(func(uint16, []string, map[string]*gomemcached.MCResponse) error); ok {
		r0 = rf(vb, keys, rv)
	} else {
		r0 = ret.Error(0)
	}
