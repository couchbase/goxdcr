...
type mockConstructorTestingTNewCollectionCreateEvent interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCollectionCreateEvent(t mockConstructorTestingTNewCollectionCreateEvent) *CollectionCreateEvent {
