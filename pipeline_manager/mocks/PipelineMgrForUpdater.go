...
type mockConstructorTestingTNewPipelineMgrForUpdater interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPipelineMgrForUpdater(t mockConstructorTestingTNewPipelineMgrForUpdater) *PipelineMgrForUpdater {
