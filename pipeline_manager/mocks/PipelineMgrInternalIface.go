...
type mockConstructorTestingTNewPipelineMgrInternalIface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPipelineMgrInternalIface(t mockConstructorTestingTNewPipelineMgrInternalIface) *PipelineMgrInternalIface {
