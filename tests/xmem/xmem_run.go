...
func startXmem(batch_count int) {
	...
	xmem = parts.NewXmemNozzle("xmem", "abc", "abc", 10, target_connectStr, options.source_bucket, options.target_bucket, options.target_bucket, options.password, base.CRMode_RevId, logger.LoggerContext())
