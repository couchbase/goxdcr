...
func (_m *ClusterHeartbeatAPI) GetHeartbeatsReceivedV1() (map[string]string, map[string][]*metadata.ReplicationSpecification, map[string][]string, map[string]time.Time, map[string]time.Time, map[string]int64, error) {
	ret := _m.Called()
...
func (_c *ClusterHeartbeatAPI_GetHeartbeatsReceivedV1_Call) Return(_a0 map[string]string, _a1 map[string][]*metadata.ReplicationSpecification, _a2 map[string][]string, _a3 map[string]time.Time, _a4 map[string]time.Time, _a5 map[string]int64, _a6 error) *ClusterHeartbeatAPI_GetHeartbeatsReceivedV1_Call {
	_c.Call.Return(_a0, _a1, _a2, _a3, _a4, _a5, _a6)
	return _c
}

func (_c *ClusterHeartbeatAPI_GetHeartbeatsReceivedV1_Call) RunAndReturn(run func() (map[string]string, map[string][]*metadata.ReplicationSpecification, map[string][]string, map[string]time.Time, map[string]time.Time, map[string]int64, error)) *ClusterHeartbeatAPI_GetHeartbeatsReceivedV1_Call {
	_c.Call.Return(run)
	return _c
}

// SendHeartbeatToRemoteV1 provides a mock function with given fields: reference, hbMetadata, ctx
func (_m *ClusterHeartbeatAPI) SendHeartbeatToRemoteV1(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata, ctx ...*utils.Context) error {
...
//   - ctx ...*utils.Context
func (_e *ClusterHeartbeatAPI_Expecter) SendHeartbeatToRemoteV1(reference interface{}, hbMetadata interface{}, ctx ...interface{}) *ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call {
	return &ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call{Call: _e.mock.On("SendHeartbeatToRemoteV1",
		append([]interface{}{reference, hbMetadata}, ctx...)...)}
}

func (_c *ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call) Run(run func(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata, ctx ...*utils.Context)) *ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call) RunAndReturn(run func(*metadata.RemoteClusterReference, *metadata.HeartbeatMetadata, ...*utils.Context) error) *ClusterHeartbeatAPI_SendHeartbeatToRemoteV1_Call {
	_c.Call.Return(run)
	return _c
}
