...
// PreReplicate provides a mock function with given fields: remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx
func (_m *CAPIService) PreReplicate(remoteBucket *service_def.RemoteBucketInfo, knownRemoteVBStatus *service_def.RemoteVBReplicationStatus, xdcrCheckpointingCapbility bool, ctx *utils.Context) (bool, metadata.TargetVBOpaque, error) {
	ret := _m.Called(remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)
	...
	var r1 metadata.TargetVBOpaque
	var r2 error
	if rf, ok := ret.Get(0).(func(*service_def.RemoteBucketInfo, *service_def.RemoteVBReplicationStatus, bool, *utils.Context) (bool, metadata.TargetVBOpaque, error)); ok {
		return rf(remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)
	}
	if rf, ok := ret.Get(0).(func(*service_def.RemoteBucketInfo, *service_def.RemoteVBReplicationStatus, bool, *utils.Context) bool); ok {
		r0 = rf(remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(*service_def.RemoteBucketInfo, *service_def.RemoteVBReplicationStatus, bool, *utils.Context) metadata.TargetVBOpaque); ok {
		r1 = rf(remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(metadata.TargetVBOpaque)
		}
	...
	if rf, ok := ret.Get(2).(func(*service_def.RemoteBucketInfo, *service_def.RemoteVBReplicationStatus, bool, *utils.Context) error); ok {
		r2 = rf(remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)
	} else {
		r2 = ret.Error(2)
	}
...
//   - ctx *utils.Context
func (_e *CAPIService_Expecter) PreReplicate(remoteBucket interface{}, knownRemoteVBStatus interface{}, xdcrCheckpointingCapbility interface{}, ctx interface{}) *CAPIService_PreReplicate_Call {
	return &CAPIService_PreReplicate_Call{Call: _e.mock.On("PreReplicate", remoteBucket, knownRemoteVBStatus, xdcrCheckpointingCapbility, ctx)}
}

func (_c *CAPIService_PreReplicate_Call) Run(run func(remoteBucket *service_def.RemoteBucketInfo, knownRemoteVBStatus *service_def.RemoteVBReplicationStatus, xdcrCheckpointingCapbility bool, ctx *utils.Context)) *CAPIService_PreReplicate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*service_def.RemoteBucketInfo), args[1].(*service_def.RemoteVBReplicationStatus), args[2].(bool), args[3].(*utils.Context))
	})
	return _c
}
...
func (_c *CAPIService_PreReplicate_Call) RunAndReturn(run func(*service_def.RemoteBucketInfo, *service_def.RemoteVBReplicationStatus, bool, *utils.Context) (bool, metadata.TargetVBOpaque, error)) *CAPIService_PreReplicate_Call {
	_c.Call.Return(run)
	return _c
}
