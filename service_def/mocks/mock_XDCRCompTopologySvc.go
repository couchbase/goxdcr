...
// DisableCERestrictions provides a mock function with no fields
func (_m *XDCRCompTopologySvc) DisableCERestrictions() (bool, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for DisableCERestrictions")
	}
...
// XDCRCompTopologySvc_DisableCERestrictions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DisableCERestrictions'
type XDCRCompTopologySvc_DisableCERestrictions_Call struct {
	*mock.Call
}

// DisableCERestrictions is a helper method to define mock.On call
func (_e *XDCRCompTopologySvc_Expecter) DisableCERestrictions() *XDCRCompTopologySvc_DisableCERestrictions_Call {
	return &XDCRCompTopologySvc_DisableCERestrictions_Call{Call: _e.mock.On("DisableCERestrictions")}
}

func (_c *XDCRCompTopologySvc_DisableCERestrictions_Call) Run(run func()) *XDCRCompTopologySvc_DisableCERestrictions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *XDCRCompTopologySvc_DisableCERestrictions_Call) Return(_a0 bool, _a1 error) *XDCRCompTopologySvc_DisableCERestrictions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *XDCRCompTopologySvc_DisableCERestrictions_Call) RunAndReturn(run func() (bool, error)) *XDCRCompTopologySvc_DisableCERestrictions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *XDCRCompTopologySvc) MyBuildVersion() (string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for MyBuildVersion")
	}
...
// XDCRCompTopologySvc_MyBuildVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MyBuildVersion'
type XDCRCompTopologySvc_MyBuildVersion_Call struct {
	*mock.Call
}

// MyBuildVersion is a helper method to define mock.On call
func (_e *XDCRCompTopologySvc_Expecter) MyBuildVersion() *XDCRCompTopologySvc_MyBuildVersion_Call {
	return &XDCRCompTopologySvc_MyBuildVersion_Call{Call: _e.mock.On("MyBuildVersion")}
}

func (_c *XDCRCompTopologySvc_MyBuildVersion_Call) Run(run func()) *XDCRCompTopologySvc_MyBuildVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *XDCRCompTopologySvc_MyBuildVersion_Call) Return(_a0 string, _a1 error) *XDCRCompTopologySvc_MyBuildVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *XDCRCompTopologySvc_MyBuildVersion_Call) RunAndReturn(run func() (string, error)) *XDCRCompTopologySvc_MyBuildVersion_Call {
	_c.Call.Return(run)
	return _c
}
