...
type mockConstructorTestingTNewBackfillMgrComponentListenerGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewBackfillMgrComponentListenerGetter(t mockConstructorTestingTNewBackfillMgrComponentListenerGetter) *BackfillMgrComponentListenerGetter {
