...
func (_c *StatsMgrIface_GetVBCountMetrics_Call) Return(_a0 service_def.VBCountMetricMap, _a1 error) *StatsMgrIface_GetVBCountMetrics_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatsMgrIface_GetVBCountMetrics_Call) RunAndReturn(run func(uint16) (service_def.VBCountMetricMap, error)) *StatsMgrIface_GetVBCountMetrics_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *StatsMgrIface_SetVBCountMetrics_Call) Run(run func(vb uint16, metricKVs service_def.VBCountMetricMap)) *StatsMgrIface_SetVBCountMetrics_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint16), args[1].(service_def.VBCountMetricMap))
	})
	return _c
}
...
func (_c *StatsMgrIface_SetVBCountMetrics_Call) RunAndReturn(run func(uint16, service_def.VBCountMetricMap) error) *StatsMgrIface_SetVBCountMetrics_Call {
	_c.Call.Return(run)
	return _c
}
