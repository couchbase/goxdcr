...
type mockConstructorTestingTNewThroughSeqnoTrackerSvc interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewThroughSeqnoTrackerSvc(t mockConstructorTestingTNewThroughSeqnoTrackerSvc) *ThroughSeqnoTrackerSvc {
