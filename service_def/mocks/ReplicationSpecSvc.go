...
func (_m *ReplicationSpecSvc) ValidateNewReplicationSpec(sourceBucket string, targetCluster string, targetBucket string, settings map[string]interface{}) (string, string, *metadata.RemoteClusterReference, map[string]error, error, []string) {
	...
	var r4 error
	if rf, ok := ret.Get(4).(func(string, string, string, map[string]interface{}) error); ok {
	...
	var r5 []string
	if rf, ok := ret.Get(5).(func(string, string, string, map[string]interface{}) []string); ok {
