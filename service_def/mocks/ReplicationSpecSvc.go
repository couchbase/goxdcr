...
type mockConstructorTestingTNewReplicationSpecSvc interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewReplicationSpecSvc(t mockConstructorTestingTNewReplicationSpecSvc) *ReplicationSpecSvc {
