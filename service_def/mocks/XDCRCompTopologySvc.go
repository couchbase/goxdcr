...
type mockConstructorTestingTNewXDCRCompTopologySvc interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewXDCRCompTopologySvc(t mockConstructorTestingTNewXDCRCompTopologySvc) *XDCRCompTopologySvc {
