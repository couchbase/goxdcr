...
func (_m *XDCRCompTopologySvc) MyCredentials() (string, string, []byte, bool, error) {
	ret := _m.Called()
...
// MyProxyPort provides a mock function with given fields:
func (_m *XDCRCompTopologySvc) MyProxyPort() (uint16, error) {
	ret := _m.Called()
