...
type mockConstructorTestingTNewSourceNotification interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSourceNotification(t mockConstructorTestingTNewSourceNotification) *SourceNotification {
