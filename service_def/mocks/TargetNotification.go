...
type mockConstructorTestingTNewTargetNotification interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTargetNotification(t mockConstructorTestingTNewTargetNotification) *TargetNotification {
