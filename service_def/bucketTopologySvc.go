...
type BucketStatsOps interface {
	...
	GetFailoverLog(requestOpts *base.FailoverLogRequest, dataTransferCtx *utils.Context) (*base.BucketFailoverLog, base.ErrorMap, error)
	// GetVBucketStats returns the vbucket stats for the bucket
	GetVBucketStats(requestOpts *base.VBucketStatsRequest, dataTransferCtx *utils.Context) (*base.BucketVBStats, base.ErrorMap, error)
}
