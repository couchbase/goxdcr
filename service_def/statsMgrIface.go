...
var GlobalStatsTable = StatisticsPropertyMap{
	...
	PIPELINE_STATUS: StatsProperty{
		...
		Description:  "The pipeline status for a specific pipeline, where 0=Paused, 1=Running",
		Notes:        "A single integer that represents the state of a pipeline, whether or not it is running or paused",
		Stability:    Committed,
