...
const (
	...
	CLOG_UNKNOWN_COLLECTION_COUNT = "clog_unknown_collections"
	CLOG_IMPOSSIBLE_RESP_COUNT    = "clog_impossible_resps"
	CLOG_FATAL_RESP_COUNT         = "clog_fatal_resps"
	CLOG_EACCESS_COUNT            = "clog_eaccesses"
