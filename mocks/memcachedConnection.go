...
type mockConstructorTestingTnewMemcachedConnection interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMemcachedConnection(t mockConstructorTestingTnewMemcachedConnection) *memcachedConnection {
