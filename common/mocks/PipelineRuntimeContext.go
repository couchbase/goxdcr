...
type mockConstructorTestingTNewPipelineRuntimeContext interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPipelineRuntimeContext(t mockConstructorTestingTNewPipelineRuntimeContext) *PipelineRuntimeContext {
