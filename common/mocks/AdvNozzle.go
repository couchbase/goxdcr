...
// AdvNozzle is an autogenerated mock type for the AdvNozzle type
type AdvNozzle struct {
	mock.Mock
}

// AdvConnector provides a mock function with given fields:
func (_m *AdvNozzle) AdvConnector() (common.AdvConnector, error) {
	ret := _m.Called()
...
func (_m *AdvNozzle) AsyncComponentEventListeners() map[string]common.AsyncComponentEventListener {
	ret := _m.Called()
...
func (_m *AdvNozzle) Close(instanceId string) error {
...
func (_m *AdvNozzle) Connector() common.Connector {
	ret := _m.Called()
...
func (_m *AdvNozzle) GetType() common.PartType {
	ret := _m.Called()
...
func (_m *AdvNozzle) Open(instanceId string) error {
	ret := _m.Called(instanceId)
...
func (_m *AdvNozzle) RaiseEvent(event *common.Event) {
	_m.Called(event)
}

// Receive provides a mock function with given fields: data
func (_m *AdvNozzle) Receive(data interface{}) error {
	ret := _m.Called(data)
...
func (_m *AdvNozzle) RegisterComponentEventListener(eventType common.ComponentEventType, listener common.ComponentEventListener) error {
...
func (_m *AdvNozzle) RegisterSpecificComponentEventListener(topic string, eventType common.ComponentEventType, listener common.ComponentEventListener) error {
...
func (_m *AdvNozzle) ResponsibleVBs() []uint16 {
	ret := _m.Called()
...
func (_m *AdvNozzle) SetAdvConnector(connector common.AdvConnector) error {
...
func (_m *AdvNozzle) SetConnector(connector common.Connector) error {
	ret := _m.Called(connector)
...
func (_m *AdvNozzle) SpecificAsyncComponentEventListeners(topic string) map[string]common.AsyncComponentEventListener {
	ret := _m.Called(topic)
...
func (_m *AdvNozzle) Start(settings metadata.ReplicationSettingsMap) error {
...
func (_m *AdvNozzle) State() common.PartState {
	ret := _m.Called()
...
func (_m *AdvNozzle) StopWithParameters(settings metadata.ReplicationSettingsMap) error {
	ret := _m.Called(settings)
...
func (_m *AdvNozzle) UnRegisterComponentEventListener(eventType common.ComponentEventType, listener common.ComponentEventListener) error {
	ret := _m.Called(eventType, listener)
...
func (_m *AdvNozzle) UnRegisterSpecificComponentEventListener(topic string, eventType common.ComponentEventType, listener common.ComponentEventListener) error {
	ret := _m.Called(topic, eventType, listener)
...
func (_m *AdvNozzle) UpdateSettings(settings metadata.ReplicationSettingsMap) error {
	ret := _m.Called(settings)
