...
type mockConstructorTestingTNewAsyncComponentEventHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAsyncComponentEventHandler(t mockConstructorTestingTNewAsyncComponentEventHandler) *AsyncComponentEventHandler {
