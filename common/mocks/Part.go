...
func (_m *Part) AdvConnector() (common.AdvConnector, error) {
	ret := _m.Called()
...
func (_m *Part) GetType() common.PartType {
	ret := _m.Called()
...
func (_m *Part) SetAdvConnector(connector common.AdvConnector) error {
