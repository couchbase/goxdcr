...
func (_m *Nozzle) AdvConnector() (common.AdvConnector, error) {
	ret := _m.Called()
...
func (_m *Nozzle) GetType() common.PartType {
	ret := _m.Called()
...
func (_m *Nozzle) SetAdvConnector(connector common.AdvConnector) error {
