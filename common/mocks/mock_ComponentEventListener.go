...
// ComponentEventListener_ListenerPipelineType_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListenerPipelineType'
type ComponentEventListener_ListenerPipelineType_Call struct {
	*mock.Call
}

// ListenerPipelineType is a helper method to define mock.On call
func (_e *ComponentEventListener_Expecter) ListenerPipelineType() *ComponentEventListener_ListenerPipelineType_Call {
	return &ComponentEventListener_ListenerPipelineType_Call{Call: _e.mock.On("ListenerPipelineType")}
}

func (_c *ComponentEventListener_ListenerPipelineType_Call) Run(run func()) *ComponentEventListener_ListenerPipelineType_Call {
...
func (_c *ComponentEventListener_ListenerPipelineType_Call) Return(_a0 common.ListenerPipelineType) *ComponentEventListener_ListenerPipelineType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ComponentEventListener_ListenerPipelineType_Call) RunAndReturn(run func() common.ListenerPipelineType) *ComponentEventListener_ListenerPipelineType_Call {
	_c.Call.Return(run)
	return _c
}
