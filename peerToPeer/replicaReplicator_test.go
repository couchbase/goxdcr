...
func TestReplicatorWithSpecAndIntervalChange(t *testing.T) {
	...
	setupMocks(utilsMock, utilsReal, xdcrComp, peerNodes, myHostAddr, specList, replSvc, queryResultErrs, queryResultsStatusCode, srcCh, nil, bucketSvc, ckptSvc, backfillSpecSvc, colManifestSvc, securitySvc, remClusterSvc, true)
	...
	setupMocks(utilsMock, utilsReal, xdcrComp, peerNodes, myHostAddr, specList2, replSvc2, queryResultErrs, queryResultsStatusCode, srcCh, nil, bucketSvc, ckptSvc, backfillSpecSvc, colManifestSvc, securitySvc, remClusterSvc, true)
...
func TestReplicatorWithSpecAndIntervalChangeNonKVNode(t *testing.T) {
	...
	setupMocks(utilsMock, utilsReal, xdcrComp, peerNodes, myHostAddr, specList, replSvc, queryResultErrs, queryResultsStatusCode, nil, base.ErrorNoSourceNozzle, bucketSvc, ckptSvc, backfillSpecSvc, colManifestSvc, securitySvc, remClusterSvc, false)
