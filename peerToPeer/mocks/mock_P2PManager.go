...
func (_m *P2PManager) SendHeartbeatToRemoteV1(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata) error {
...
func (_e *P2PManager_Expecter) SendHeartbeatToRemoteV1(reference interface{}, hbMetadata interface{}) *P2PManager_SendHeartbeatToRemoteV1_Call {
	return &P2PManager_SendHeartbeatToRemoteV1_Call{Call: _e.mock.On("SendHeartbeatToRemoteV1", reference, hbMetadata)}
}

func (_c *P2PManager_SendHeartbeatToRemoteV1_Call) Run(run func(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata)) *P2PManager_SendHeartbeatToRemoteV1_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *P2PManager_SendHeartbeatToRemoteV1_Call) RunAndReturn(run func(*metadata.RemoteClusterReference, *metadata.HeartbeatMetadata) error) *P2PManager_SendHeartbeatToRemoteV1_Call {
	_c.Call.Return(run)
	return _c
}
