...
func (_m *P2PManager) SendCngConnectionPreCheckRequest(_a0 *metadata.RemoteClusterReference, _a1 peerToPeer.InitRemoteClusterRefFunc, _a2 string) {
	_m.Called(_a0, _a1, _a2)
}

// P2PManager_SendCngConnectionPreCheckRequest_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendCngConnectionPreCheckRequest'
type P2PManager_SendCngConnectionPreCheckRequest_Call struct {
	*mock.Call
}
...
//   - _a2 string
func (_e *P2PManager_Expecter) SendCngConnectionPreCheckRequest(_a0 interface{}, _a1 interface{}, _a2 interface{}) *P2PManager_SendCngConnectionPreCheckRequest_Call {
	return &P2PManager_SendCngConnectionPreCheckRequest_Call{Call: _e.mock.On("SendCngConnectionPreCheckRequest", _a0, _a1, _a2)}
}

func (_c *P2PManager_SendCngConnectionPreCheckRequest_Call) Run(run func(_a0 *metadata.RemoteClusterReference, _a1 peerToPeer.InitRemoteClusterRefFunc, _a2 string)) *P2PManager_SendCngConnectionPreCheckRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *P2PManager_SendCngConnectionPreCheckRequest_Call) Return() *P2PManager_SendCngConnectionPreCheckRequest_Call {
	_c.Call.Return()
	return _c
}

func (_c *P2PManager_SendCngConnectionPreCheckRequest_Call) RunAndReturn(run func(*metadata.RemoteClusterReference, peerToPeer.InitRemoteClusterRefFunc, string)) *P2PManager_SendCngConnectionPreCheckRequest_Call {
	_c.Run(run)
	return _c
}
...
// SendHeartbeatToRemoteV1 provides a mock function with given fields: reference, hbMetadata, ctx
func (_m *P2PManager) SendHeartbeatToRemoteV1(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata, ctx ...*utils.Context) error {
	_va := make([]interface{}, len(ctx))
	for _i := range ctx {
		_va[_i] = ctx[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, reference, hbMetadata)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*metadata.RemoteClusterReference, *metadata.HeartbeatMetadata, ...*utils.Context) error); ok {
		r0 = rf(reference, hbMetadata, ctx...)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx ...*utils.Context
func (_e *P2PManager_Expecter) SendHeartbeatToRemoteV1(reference interface{}, hbMetadata interface{}, ctx ...interface{}) *P2PManager_SendHeartbeatToRemoteV1_Call {
	return &P2PManager_SendHeartbeatToRemoteV1_Call{Call: _e.mock.On("SendHeartbeatToRemoteV1",
		append([]interface{}{reference, hbMetadata}, ctx...)...)}
}

func (_c *P2PManager_SendHeartbeatToRemoteV1_Call) Run(run func(reference *metadata.RemoteClusterReference, hbMetadata *metadata.HeartbeatMetadata, ctx ...*utils.Context)) *P2PManager_SendHeartbeatToRemoteV1_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(*metadata.RemoteClusterReference), args[1].(*metadata.HeartbeatMetadata), variadicArgs...)
	})
	return _c
}
...
func (_c *P2PManager_SendHeartbeatToRemoteV1_Call) RunAndReturn(run func(*metadata.RemoteClusterReference, *metadata.HeartbeatMetadata, ...*utils.Context) error) *P2PManager_SendHeartbeatToRemoteV1_Call {
	_c.Call.Return(run)
	return _c
}
