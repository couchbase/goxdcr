...
type UtilsIface interface {
	...
	GetReplicasInfo(bucketInfo map[string]interface{}, isStrictlySecure bool, recycledStringStringMap base.StringStringMap, recycledVbHostMapGetter func(vbnos []uint16) base.VbHostsMapType) (base.VbHostsMapType, base.StringStringMap, int, []uint16, error)
	GetServersListFromBucketInfo(bucketInfo map[string]interface{}) ([]string, error)
	GetServerVBucketsMap(connStr, bucketName string, bucketInfo map[string]interface{}, recycledMap map[string][]uint16) (map[string][]uint16, error)
