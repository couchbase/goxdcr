...
func (_m *UtilsIface) CheckForTransactionXattrsInUprEvent(uprEvent *memcached.UprEvent, dp utils.DataPoolIface, slicesToBeReleased *[][]byte, needToFilterBody bool) (bool, []byte, int, error, string, int64, []byte) {
	...
	var r6 []byte
	if rf, ok := ret.Get(6).(func(*memcached.UprEvent, utils.DataPoolIface, *[][]byte, bool) []byte); ok {
...
// GetHttpClient provides a mock function with given fields: username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, keepClientAlive
func (_m *UtilsIface) GetHttpClient(username string, authMech base.HttpAuthMech, certificate []byte, san_in_certificate bool, clientCertificate []byte, clientKey []byte, ssl_con_str string, logger *log.CommonLogger, keepClientAlive bool) (*http.Client, error) {
	ret := _m.Called(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, keepClientAlive)

	var r0 *http.Client
	if rf, ok := ret.Get(0).(func(string, base.HttpAuthMech, []byte, bool, []byte, []byte, string, *log.CommonLogger, bool) *http.Client); ok {
		r0 = rf(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, keepClientAlive)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, base.HttpAuthMech, []byte, bool, []byte, []byte, string, *log.CommonLogger, bool) error); ok {
		r1 = rf(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, keepClientAlive)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *UtilsIface) GetSecuritySettingsAndDefaultPoolInfo(hostAddr string, hostHttpsAddr string, username string, password string, certificate []byte, clientCertificate []byte, clientKey []byte, scramShaEnabled bool, logger *log.CommonLogger) (base.HttpAuthMech, map[string]interface{}, error) {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(string, string, string, string, []byte, []byte, []byte, bool, *log.CommonLogger) error); ok {
...
type mockConstructorTestingTNewUtilsIface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUtilsIface(t mockConstructorTestingTNewUtilsIface) *UtilsIface {
	mock := &UtilsIface{}
	mock.Mock.Test(t)
