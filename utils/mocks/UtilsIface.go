...
// ConstructHttpRequest provides a mock function with given fields: baseURL, path, preservePathEncoding, username, password, certificate, setUserAuth, httpCommand, contentType, body, logger
func (_m *UtilsIface) ConstructHttpRequest(baseURL string, path string, preservePathEncoding bool, username string, password string, certificate []byte, setUserAuth bool, httpCommand string, contentType string, body []byte, logger *log.CommonLogger) (*http.Request, string, error) {
	ret := _m.Called(baseURL, path, preservePathEncoding, username, password, certificate, setUserAuth, httpCommand, contentType, body, logger)

	var r0 *http.Request
	if rf, ok := ret.Get(0).(func(string, string, bool, string, string, []byte, bool, string, string, []byte, *log.CommonLogger) *http.Request); ok {
		r0 = rf(baseURL, path, preservePathEncoding, username, password, certificate, setUserAuth, httpCommand, contentType, body, logger)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 string
	if rf, ok := ret.Get(1).(func(string, string, bool, string, string, []byte, bool, string, string, []byte, *log.CommonLogger) string); ok {
		r1 = rf(baseURL, path, preservePathEncoding, username, password, certificate, setUserAuth, httpCommand, contentType, body, logger)
	} else {
		r1 = ret.Get(1).(string)
	}

	var r2 error
	if rf, ok := ret.Get(2).(func(string, string, bool, string, string, []byte, bool, string, string, []byte, *log.CommonLogger) error); ok {
		r2 = rf(baseURL, path, preservePathEncoding, username, password, certificate, setUserAuth, httpCommand, contentType, body, logger)
	} else {
		r2 = ret.Error(2)
	}
