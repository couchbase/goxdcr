...
func (_m *UtilsIface) CngGetVbucketInfo(client base.CngClient, request *base.GrpcRequest[*internal_xdcr_v1.GetVbucketInfoRequest], handler utils.GrpcStreamHandler[*internal_xdcr_v1.GetVbucketInfoResponse]) {
...
func (_c *UtilsIface_CngGetVbucketInfo_Call) Return() *UtilsIface_CngGetVbucketInfo_Call {
	_c.Call.Return()
	return _c
}
...
func (_m *UtilsIface) CngWatchCollections(client base.CngClient, request *base.GrpcRequest[*internal_xdcr_v1.WatchCollectionsRequest], handler utils.GrpcStreamHandler[*internal_xdcr_v1.WatchCollectionsResponse]) {
	_m.Called(client, request, handler)
}
...
func (_c *UtilsIface_CngWatchCollections_Call) Return() *UtilsIface_CngWatchCollections_Call {
	_c.Call.Return()
	return _c
}

func (_c *UtilsIface_CngWatchCollections_Call) RunAndReturn(run func(base.CngClient, *base.GrpcRequest[*internal_xdcr_v1.WatchCollectionsRequest], utils.GrpcStreamHandler[*internal_xdcr_v1.WatchCollectionsResponse])) *UtilsIface_CngWatchCollections_Call {
	_c.Run(run)
	return _c
}
...
// GetBucketInfo provides a mock function with given fields: logger, req, ctx
func (_m *UtilsIface) GetBucketInfo(logger *log.CommonLogger, req *utils.GetBucketInfoReq, ctx ...*utils.Context) (map[string]interface{}, error) {
	_va := make([]interface{}, len(ctx))
	for _i := range ctx {
		_va[_i] = ctx[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, logger, req)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r0 map[string]interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(*log.CommonLogger, *utils.GetBucketInfoReq, ...*utils.Context) (map[string]interface{}, error)); ok {
		return rf(logger, req, ctx...)
	}
	if rf, ok := ret.Get(0).(func(*log.CommonLogger, *utils.GetBucketInfoReq, ...*utils.Context) map[string]interface{}); ok {
		r0 = rf(logger, req, ctx...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]interface{})
		}
	...
	if rf, ok := ret.Get(1).(func(*log.CommonLogger, *utils.GetBucketInfoReq, ...*utils.Context) error); ok {
		r1 = rf(logger, req, ctx...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - req *utils.GetBucketInfoReq
//   - ctx ...*utils.Context
func (_e *UtilsIface_Expecter) GetBucketInfo(logger interface{}, req interface{}, ctx ...interface{}) *UtilsIface_GetBucketInfo_Call {
	return &UtilsIface_GetBucketInfo_Call{Call: _e.mock.On("GetBucketInfo",
		append([]interface{}{logger, req}, ctx...)...)}
}

func (_c *UtilsIface_GetBucketInfo_Call) Run(run func(logger *log.CommonLogger, req *utils.GetBucketInfoReq, ctx ...*utils.Context)) *UtilsIface_GetBucketInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]*utils.Context, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
				variadicArgs[i] = a.(*utils.Context)
			}
		}
		run(args[0].(*log.CommonLogger), args[1].(*utils.GetBucketInfoReq), variadicArgs...)
	})
	return _c
}
...
func (_c *UtilsIface_GetBucketInfo_Call) RunAndReturn(run func(*log.CommonLogger, *utils.GetBucketInfoReq, ...*utils.Context) (map[string]interface{}, error)) *UtilsIface_GetBucketInfo_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetDefaultPoolInfoUsingHttps provides a mock function with given fields: hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger, _a7
func (_m *UtilsIface) GetDefaultPoolInfoUsingHttps(hostHttpsAddr string, username string, password string, certificate []byte, clientCertificate []byte, clientKey []byte, logger *log.CommonLogger, _a7 ...*utils.Context) (map[string]interface{}, int, error) {
	...
	if rf, ok := ret.Get(0).(func(string, string, string, []byte, []byte, []byte, *log.CommonLogger, ...*utils.Context) (map[string]interface{}, int, error)); ok {
		return rf(hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger, _a7...)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, []byte, []byte, []byte, *log.CommonLogger, ...*utils.Context) map[string]interface{}); ok {
		r0 = rf(hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger, _a7...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]interface{})
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, []byte, []byte, []byte, *log.CommonLogger, ...*utils.Context) int); ok {
		r1 = rf(hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger, _a7...)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(string, string, string, []byte, []byte, []byte, *log.CommonLogger, ...*utils.Context) error); ok {
		r2 = rf(hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger, _a7...)
	} else {
		r2 = ret.Error(2)
	}
...
//   - logger *log.CommonLogger
//   - _a7 ...*utils.Context
func (_e *UtilsIface_Expecter) GetDefaultPoolInfoUsingHttps(hostHttpsAddr interface{}, username interface{}, password interface{}, certificate interface{}, clientCertificate interface{}, clientKey interface{}, logger interface{}, _a7 ...interface{}) *UtilsIface_GetDefaultPoolInfoUsingHttps_Call {
	return &UtilsIface_GetDefaultPoolInfoUsingHttps_Call{Call: _e.mock.On("GetDefaultPoolInfoUsingHttps",
		append([]interface{}{hostHttpsAddr, username, password, certificate, clientCertificate, clientKey, logger}, _a7...)...)}
}

func (_c *UtilsIface_GetDefaultPoolInfoUsingHttps_Call) Run(run func(hostHttpsAddr string, username string, password string, certificate []byte, clientCertificate []byte, clientKey []byte, logger *log.CommonLogger, _a7 ...*utils.Context)) *UtilsIface_GetDefaultPoolInfoUsingHttps_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetDefaultPoolInfoUsingScramSha provides a mock function with given fields: hostAddr, username, password, logger, _a4
func (_m *UtilsIface) GetDefaultPoolInfoUsingScramSha(hostAddr string, username string, password string, logger *log.CommonLogger, _a4 ...*utils.Context) (map[string]interface{}, int, error) {
	...
	if rf, ok := ret.Get(1).(func(string, string, string, *log.CommonLogger, ...*utils.Context) int); ok {
		r1 = rf(hostAddr, username, password, logger, _a4...)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(string, string, string, *log.CommonLogger, ...*utils.Context) error); ok {
		r2 = rf(hostAddr, username, password, logger, _a4...)
	} else {
		r2 = ret.Error(2)
	}
...
//   - logger *log.CommonLogger
//   - _a4 ...*utils.Context
func (_e *UtilsIface_Expecter) GetDefaultPoolInfoUsingScramSha(hostAddr interface{}, username interface{}, password interface{}, logger interface{}, _a4 ...interface{}) *UtilsIface_GetDefaultPoolInfoUsingScramSha_Call {
	return &UtilsIface_GetDefaultPoolInfoUsingScramSha_Call{Call: _e.mock.On("GetDefaultPoolInfoUsingScramSha",
		append([]interface{}{hostAddr, username, password, logger}, _a4...)...)}
}

func (_c *UtilsIface_GetDefaultPoolInfoUsingScramSha_Call) Run(run func(hostAddr string, username string, password string, logger *log.CommonLogger, _a4 ...*utils.Context)) *UtilsIface_GetDefaultPoolInfoUsingScramSha_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetHttpClient provides a mock function with given fields: username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, clientCertKeyPair, _a9
func (_m *UtilsIface) GetHttpClient(username string, authMech base.HttpAuthMech, certificate []byte, san_in_certificate bool, clientCertificate []byte, clientKey []byte, ssl_con_str string, logger *log.CommonLogger, clientCertKeyPair []tls.Certificate, _a9 ...*utils.Context) (*http.Client, error) {
	_va := make([]interface{}, len(_a9))
	for _i := range _a9 {
		_va[_i] = _a9[_i]
	}
	var _ca []interface{}
	...
	if rf, ok := ret.Get(0).(func(string, base.HttpAuthMech, []byte, bool, []byte, []byte, string, *log.CommonLogger, []tls.Certificate, ...*utils.Context) (*http.Client, error)); ok {
		return rf(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, clientCertKeyPair, _a9...)
	}
	if rf, ok := ret.Get(0).(func(string, base.HttpAuthMech, []byte, bool, []byte, []byte, string, *log.CommonLogger, []tls.Certificate, ...*utils.Context) *http.Client); ok {
		r0 = rf(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, clientCertKeyPair, _a9...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, base.HttpAuthMech, []byte, bool, []byte, []byte, string, *log.CommonLogger, []tls.Certificate, ...*utils.Context) error); ok {
		r1 = rf(username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, clientCertKeyPair, _a9...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - _a9 ...*utils.Context
func (_e *UtilsIface_Expecter) GetHttpClient(username interface{}, authMech interface{}, certificate interface{}, san_in_certificate interface{}, clientCertificate interface{}, clientKey interface{}, ssl_con_str interface{}, logger interface{}, clientCertKeyPair interface{}, _a9 ...interface{}) *UtilsIface_GetHttpClient_Call {
	return &UtilsIface_GetHttpClient_Call{Call: _e.mock.On("GetHttpClient",
		append([]interface{}{username, authMech, certificate, san_in_certificate, clientCertificate, clientKey, ssl_con_str, logger, clientCertKeyPair}, _a9...)...)}
}

func (_c *UtilsIface_GetHttpClient_Call) Run(run func(username string, authMech base.HttpAuthMech, certificate []byte, san_in_certificate bool, clientCertificate []byte, clientKey []byte, ssl_con_str string, logger *log.CommonLogger, clientCertKeyPair []tls.Certificate, _a9 ...*utils.Context)) *UtilsIface_GetHttpClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetTLSTrackedTransport provides a mock function with given fields: tr, _a1
func (_m *UtilsIface) GetTLSTrackedTransport(tr *http.Transport, _a1 ...*utils.Context) http.RoundTripper {
...
//   - tr *http.Transport
//   - _a1 ...*utils.Context
func (_e *UtilsIface_Expecter) GetTLSTrackedTransport(tr interface{}, _a1 ...interface{}) *UtilsIface_GetTLSTrackedTransport_Call {
	return &UtilsIface_GetTLSTrackedTransport_Call{Call: _e.mock.On("GetTLSTrackedTransport",
		append([]interface{}{tr}, _a1...)...)}
}

func (_c *UtilsIface_GetTLSTrackedTransport_Call) Run(run func(tr *http.Transport, _a1 ...*utils.Context)) *UtilsIface_GetTLSTrackedTransport_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetTerseBucketInfo provides a mock function with given fields: hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger, ctx
func (_m *UtilsIface) GetTerseBucketInfo(hostAddr string, bucketName string, username string, password string, authMech base.HttpAuthMech, certificate []byte, sanInCertificate bool, clientCert []byte, clientKey []byte, logger *log.CommonLogger, ctx ...*utils.Context) (map[string]interface{}, error) {
	_va := make([]interface{}, len(ctx))
	for _i := range ctx {
		_va[_i] = ctx[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, string, base.HttpAuthMech, []byte, bool, []byte, []byte, *log.CommonLogger, ...*utils.Context) (map[string]interface{}, error)); ok {
		return rf(hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger, ctx...)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, string, base.HttpAuthMech, []byte, bool, []byte, []byte, *log.CommonLogger, ...*utils.Context) map[string]interface{}); ok {
		r0 = rf(hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger, ctx...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]interface{})
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, string, base.HttpAuthMech, []byte, bool, []byte, []byte, *log.CommonLogger, ...*utils.Context) error); ok {
		r1 = rf(hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger, ctx...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - logger *log.CommonLogger
//   - ctx ...*utils.Context
func (_e *UtilsIface_Expecter) GetTerseBucketInfo(hostAddr interface{}, bucketName interface{}, username interface{}, password interface{}, authMech interface{}, certificate interface{}, sanInCertificate interface{}, clientCert interface{}, clientKey interface{}, logger interface{}, ctx ...interface{}) *UtilsIface_GetTerseBucketInfo_Call {
	return &UtilsIface_GetTerseBucketInfo_Call{Call: _e.mock.On("GetTerseBucketInfo",
		append([]interface{}{hostAddr, bucketName, username, password, authMech, certificate, sanInCertificate, clientCert, clientKey, logger}, ctx...)...)}
}

func (_c *UtilsIface_GetTerseBucketInfo_Call) Run(run func(hostAddr string, bucketName string, username string, password string, authMech base.HttpAuthMech, certificate []byte, sanInCertificate bool, clientCert []byte, clientKey []byte, logger *log.CommonLogger, ctx ...*utils.Context)) *UtilsIface_GetTerseBucketInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]*utils.Context, len(args)-10)
		for i, a := range args[10:] {
			if a != nil {
...
func (_c *UtilsIface_GetTerseBucketInfo_Call) RunAndReturn(run func(string, string, string, string, base.HttpAuthMech, []byte, bool, []byte, []byte, *log.CommonLogger, ...*utils.Context) (map[string]interface{}, error)) *UtilsIface_GetTerseBucketInfo_Call {
	_c.Call.Return(run)
	return _c
}
...
// UtilsIface_TargetHasSharedExternalHostnameAndMgmtPort_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TargetHasSharedExternalHostnameAndMgmtPort'
type UtilsIface_TargetHasSharedExternalHostnameAndMgmtPort_Call struct {
	*mock.Call
}
...
func (_c *UtilsIface_TargetHasSharedExternalHostnameAndMgmtPort_Call) Return(_a0 bool, _a1 error) *UtilsIface_TargetHasSharedExternalHostnameAndMgmtPort_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
