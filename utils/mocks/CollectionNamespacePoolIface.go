...
type mockConstructorTestingTNewCollectionNamespacePoolIface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCollectionNamespacePoolIface(t mockConstructorTestingTNewCollectionNamespacePoolIface) *CollectionNamespacePoolIface {
