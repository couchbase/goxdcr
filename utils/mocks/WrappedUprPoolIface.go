...
type mockConstructorTestingTNewWrappedUprPoolIface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewWrappedUprPoolIface(t mockConstructorTestingTNewWrappedUprPoolIface) *WrappedUprPoolIface {
