...
func setupBoilerPlate() (*commonMock.Pipeline, *commonMock.SourceNozzle, *service_def.ReplicationSpecSvc, *commonMock.PipelineRuntimeContext, *commonMock.PipelineSupervisorSvc, *commonMock.Nozzle) {
